...
A fully compiled open source language, so anyone can name keywords as they please. In addition to the binary executable file, the compiler generates a graphical dump in the form of a binary program tree and an x86-64 assembler std::vectoring in nasm syntax.
## Syntax
...
```
If you want to compile an assembler std::vectoring, then use nasm and link together with the stdlib.o file.
